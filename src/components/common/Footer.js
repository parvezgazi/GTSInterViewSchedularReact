          ...
          <div className="row">
            <div className="col-md-3 pt-2">
              ...
              <ul className="list-unstyled">
                <h5><a href="/ServiceProvider" class="text-white font-bold" >Services By Location:</a></h5>
                <p><a href="#" class=" text-white" >Services in Bangalore</a></p>
                <p><a href="#" class=" text-white" >Services in Chennai</a></p>
                <p><a href="#" class=" text-white" >Services in Kerala</a></p>
                <p><a href="#" class=" text-white" >Services in Delhi</a></p>
                <p><a href="#" class=" text-white" >Services in Mumbai</a></p>
              </ul>
            </div>
            ...
            <div className="col-md-3 pt-2">
              ...
              <ul className="list-unstyled">
                <h5><a href="#" class="text-white font-bold" >Popular Searches:</a></h5>
            ...
            <div className="col-md-3 pt-2">
              ...
              <ul className="list-unstyled">
                <h5><a href="#" class="text-white font-bold">More on GTS Platform:</a></h5>
