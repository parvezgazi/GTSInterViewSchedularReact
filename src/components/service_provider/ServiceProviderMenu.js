...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <NavDropdown title={<span style={{color:'black',fontSize:"11px"}}><b><center>MANAGE</center>TRAININGS</b></span>} >
            ...
            <NavDropdown.Item onClick={()=>this.setUserId(jsonPayLoad.user_id)} href="/gts/wish-for-training"><span style={{fontSize:"11px"}}><b>WISH FOR TRAINING</b></span></NavDropdown.Item>
          </NavDropdown>
